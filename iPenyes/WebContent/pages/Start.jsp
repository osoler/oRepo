...
<link rel="stylesheet" 		href="/css/commonPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/headerPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/footerPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/listPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/filterPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/detailPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/photoPenyes.css?cache=4">
<link rel="stylesheet" 		href="/css/mapPenyes.css?cache=4">
...
<script src="/scripts/configuration.js?cache=4"></script>
<script src="/scripts/initialization.js?cache=4"></script>
<script src="/scripts/3rdpartyscripts/add2home.js?cache=4"></script>
<script src="/scripts/navigation.js?cache=4"></script>
<script src="/scripts/doubleTap.js?cache=4"></script>              
<script src="/scripts/detail.js?cache=4"></script>                      
<script src="/scripts/maps.js?cache=4"></script>
<script src="/scripts/list.js?cache=4"></script>
<script src="/scripts/filter.js?cache=4"></script>
</head>    
