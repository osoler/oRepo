...
var initPenyes = function() {
	...
	function getMaxScrollForTransition() {
		return 65536;
	}
	;
	...
	function updateOrientation() {
		...
		if (this.orientation === undefined) {
			...
			this.orientation = 'landscape'; // Assumed default, most laptop and
											// PC screens.
	...
	function getScale() {
		...
		// Abort. Screen width is greater than the viewport width (not
		// fullscreen).
		if (screen.width > viewportWidth) {
			console
					.log('Aborted viewport scale measurement. Screen width > viewport width');
			return;
