...
public class Utils {
    ...
    public static PenyaDetail randomPenyaDetail(){
    	...
    	double randX = Math.random();
 	    ...
 	    penya.socialNetworks = new HashMap<>();
